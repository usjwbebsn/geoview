  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "w-full max-w-lg rounded-lg border border-panel-border bg-panel p-6 shadow-panel",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-3 top-3 rounded p-1 text-text-muted hover:text-text-secondary transition-colors">
        <X className="h-4 w-4" />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description ref={ref} className={cn("text-xs text-text-secondary", className)} {...props} />
));
